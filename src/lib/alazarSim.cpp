...
RETURN_CODE AlazarGetSDKVersion(uint8_t *MajorNumber, uint8_t *MinorNumber,
...
the windows SDK is not the same as what is used in the linux SDK.  BUT the
ATSApi.dll
...
todo - since the complete list of enums is available in the Linux API header
file
...
U32 AlazarBoardsInSystemBySystemID(U32 sid) { return 1; }
...
U32 AlazarGetBoardKind(HANDLE h) { return ATS9850; }
...
RETURN_CODE AlazarGetChannelInfo(HANDLE BoardHandle, U32 *MemorySizeInSamples,
                                 U8 *BitsPerSample) {
  *MemorySizeInSamples = 256000000;
  *BitsPerSample = 8;
  return ApiSuccess;
}
RETURN_CODE AlazarGetDriverVersion(U8 *MajorNumber, U8 *MinorNumber,
                                   U8 *RevisionNumber) {
  *MajorNumber = 5;
  *MinorNumber = 10;
  *RevisionNumber = 6;
...
HANDLE AlazarGetSystemHandle(U32 SystemId) { return (HANDLE)&dummyBoard; }

RETURN_CODE AlazarQueryCapability(HANDLE BoardHandle, U32 Capability,
                                  U32 Reserved, U32 *Value) {
...
RETURN_CODE AlazarSetLED(HANDLE BoardHandle, U32 LedOn) { return ApiSuccess; }
...
AlazarSetTriggerOperation(HANDLE h, U32 TriggerOperation,
                          U32 TriggerEngine1 /*j,K*/, U32 Source1, U32 Slope1,
                          U32 Level1, U32 TriggerEngine2 /*j,K*/, U32 Source2,
                          U32 Slope2, U32 Level2) {
  return ApiSuccess;
}

RETURN_CODE AlazarSetTriggerDelay(HANDLE h, U32 Delay) { return ApiSuccess; }
...
RETURN_CODE AlazarBeforeAsyncRead(HANDLE hBoard, U32 uChannelSelect,
                                  ...
                                  U32 uRecordsPerAcquisition, U32 uFlags) {
...
RETURN_CODE AlazarStartCapture(HANDLE h) { return ApiSuccess; }
